...
function [besterr,bestvalues,fminval]= EFOsc20(N_var,N_emp,Max_gen,minval,maxval,R_rate,Ps_rate,P_field,N_field,E)
...
for i=1:N_emp
    fit(i) = fitnessfuncsc208(em_pop(i,:),E); 
end
...
%     new_emp(N_var+1) = cec14_func(new_emp(1:N_var)',problemIndex);
        new_emp(N_var+1) = fitnessfuncsc208(new_emp(1:N_var),E); 
