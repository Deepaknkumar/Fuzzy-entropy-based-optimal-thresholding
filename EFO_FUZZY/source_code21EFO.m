...
for k=1:3
%     E(k,:) = imhist(I(:,:,k));
    [Entp(k,:),values(k,:),convplot(k,:)] = EFOsc20(N_var,N_emp,Max_gen,minval,maxval,R_rate,Ps_rate,P_field,N_field,E(k,:));       %%% threshold levels and minimum Entropy obtained
