...
function [besterr,bestvalues,fminval]= EFOsc20otsu(N_var,N_emp,Max_gen,minval,maxval,R_rate,Ps_rate,P_field,N_field,E,muT)
...
for i=1:N_emp
    fit(i) = fitnessfuncsc20otsu(em_pop(i,:),E,muT); 
end
...
%     new_emp(N_var+1) = cec14_func(new_emp(1:N_var)',problemIndex);
        new_emp(N_var+1) = fitnessfuncsc20otsu(new_emp(1:N_var),E,muT); 
