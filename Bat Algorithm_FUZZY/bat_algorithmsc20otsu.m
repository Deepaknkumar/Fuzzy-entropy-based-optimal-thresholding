...
function [fmin,best,fminval]=bat_algorithmsc20otsu(para,nub,E,muT)
% Display help
...
for i=1:n,
  ...
  Sol(i,:) = sort(round(Sol(i,:)),2);
  Fitness(i)=fitnessfuncsc20otsu(Sol(i,:),E,muT);
end
...
% Loop over all bats/solutions
     ...
     % Evaluate new solutions
            S(i,:) = sort(round(S(i,:)),2);
            S(i,:)=simplebounds(S(i,:),Lb,Ub);
           Fnew=fitnessfuncsc20otsu(S(i,:),E,muT);
